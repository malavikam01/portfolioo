...
const About = () => {
  ...
  const certifications = (
    <ul className="list-disc list-inside text-white">
      ...
      <li>Attended Cyber Security Webinar </li> */}
    </ul>
  );
  ...
  return (
    ...
    <meta name="keywords" content="Malavika, Software Developer, Web Developer" />
    ...
    />
      ...
      <div className="flex flex-col h-full w-full md:w-2/3 mx-2">
        ...
        <motion.img
          src={Profile}
          alt="Malavika M - Software Developer"
